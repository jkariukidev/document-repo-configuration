...
set "JAVA_TOOL_OPTIONS=%JAVA_TOOL_OPTIONS% -Dencryption.keystore.type=JCEKS -Dencryption.cipherAlgorithm=DESede/CBC/PKCS5Padding -Dencryption.keyAlgorithm=DESede -Dencryption.keystore.location=C:/Alfresco/alf_data/keystore/ssl.keystore -Dmetadata-keystore.password=keystore -Dmetadata-keystore.aliases=metadata -Dmetadata-keystore.metadata.password=keystore -Dmetadata-keystore.metadata.algorithm=DESede"
